  ...
  return (
    <S.Containser>
        <div className="g-b">
            <div className='g-w'>
                <div className='co'>
            <img src ={zz} className = "zz"></img>
                </div>
                <div className='co2'>
            <div className='g-title'>REGISTER</div>
            <div className='g-c'>아트앤가이드의 다양한 서비스를 이용하시려면 회원가입하셈</div>
            <label  className='b'>
               <input type ="checkbox" checked={allCheck} onChange={allBtnEvent } className='check'/>
               모두동의
             </label>
            <div className='g-n'>회원가입약관<div className='m'>[필수]</div></div>
            <div  className='boxs'>
               <div className='bxi'>
                제1조(목적)
...
①“몰” 이란 ㈜열매컴퍼니가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 쇼핑몰을 운영하는 사업자의 의미로도 사용합니다.
             ...
             <div className='g-n2'>개인정보취급방침<div className='m'>[필수]</div></div>
             <div  className='boxs'>
               <div className='bxi'>
                제1조(목적)
